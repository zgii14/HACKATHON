    ...
    return (
        <div className="flex lg:hidden items-center justify-end">
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
                ...
                <SheetContent showClose={false} className="w-screen border-none bg-[#0a0a0f]/95 backdrop-blur-2xl">
                    ...
                    {/* Logo */}
                    <div className="flex items-center pr-12 pt-2 pb-6 border-b border-white/[0.06]">
                        <svg width="102" height="34" className="shrink-0" viewBox="0 0 180 60" xmlns="http://www.w3.org/2000/svg" aria-label="GitHire">
