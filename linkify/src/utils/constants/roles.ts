...
/** Rute netral — boleh diakses role mana pun (mis. pengaturan akun, admin hidden, chat). */
export const SHARED_ROUTE_PREFIXES = ["/dashboard/account", "/dashboard/admin", "/dashboard/chat"] as const;
